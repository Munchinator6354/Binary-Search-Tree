...
int main() {
  ...
  while (!infile.eof()) {
    ...
    cout << "Before T.displaySideways():" << endl;
    T.displaySideways();
    cout << "After T.displaySideways():" << endl;

    cout << "Before dup.displaySideways():" << endl;
    dup.displaySideways();
    cout << "After dup.displaySideways():" << endl;
...
//   cout << endl;
//   BinTree first(T);                  // test copy constructor
//   // dup = T;                     // test operator=, self-assignment -----------------------------------------------
...
//     cout << "Calling T2.displaySidways: " << endl << endl;
//     T2.displaySideways();
//     cout << "After calling T2.displaySidways: " << endl << endl;
    
//     cout << "T == T2?     " << (T == T2 ? "equal" : "not equal") << endl;
//     cout << "T != first?  " << (T != first ? "not equal" : "equal") << endl;
//     cout << "T == dup?    " << (T == dup ? "equal" : "not equal") << endl;
    
//     cout << "Calling T.displaySidways: " << endl << endl;
//     T.displaySideways();
//     cout << "After calling T.displaySidways: " << endl << endl;

//     cout << "Calling dup.displaySidways: " << endl << endl;
//     dup.displaySideways();
//     cout << "After calling dup.displaySidways: " << endl << endl;
    
//     cout << "dup != T?  " << (dup != T ? "not equal" : "equal") << endl;


    
//     cout << "dup = T: " << endl << endl;
//     dup = T; //--------------------------------------------------------------------------------------------------------
//     cout << "after dup = T: " << endl << endl;
...
//     // // somewhat test bstreeToArray and arrayToBSTree
//     // cout << "before calling bstreeToArray: " << endl << endl;
//     // T.bstreeToArray(ndArray);
//     // cout << "bstreeToArray has been called: " << endl;
